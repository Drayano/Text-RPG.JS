function getItem(identifier: number) {
    (document.getElementById(`item${identifier}`) as HTMLElement).style.display = "block";
    ...
    (document.getElementById(`item${identifier}-number`) as HTMLElement).innerHTML = `${items_inventory[identifier - 1]}`;
}

function useItem(e: any) {
...
function buyItem(e: any) {
    if (e.target.id === "potion-shop") {
        (document.getElementById("potion-shop") as HTMLInputElement).disabled = true;
        (document.getElementById("sword-shop") as HTMLInputElement).disabled = true;
        (document.getElementById("shield-shop") as HTMLInputElement).disabled = true;
        ...
        (document.getElementById("inventory") as HTMLElement).style.display = "flex";
    }
